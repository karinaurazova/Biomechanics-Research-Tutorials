# Tutorial 21 master class — Finite-Element Growth Model

## Purpose

This 120-minute master class turns Tutorial 21 into a guided teaching session on finite-element growth modelling with eigenstrain, residual stress, boundary conditions and feedback.  The session uses only the repository code, synthetic data and saved visualizations, so participants can reproduce every result after the workshop.
...
1. explain the modelling question addressed by Tutorial 21;
...
- assemble and solve a small finite-element growth problem.
- inspect boundary conditions, residual norms and reaction forces.
- compare frozen growth, stress feedback and fibre-only feedback scenarios.
...
3. Run `python tutorials/21-finite-element-growth-model/reproduce.py`.
